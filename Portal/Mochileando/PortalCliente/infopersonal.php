            ...
            <div class = "col-md-8 col-md-offset-2">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="Password" class="form-control"  title="La contraseña contener una mayuscula, una minuscula, un número, un caracter y debe ser de más de 8 caracteres" pattern="(?=(?:.*\d){1})(?=(?:.*[A-Z]){1})(?=(?:.*[a-z]){1})(?=(?:.*[@$+=`~?><#%&*!ยก\-_]){1})\S{6,}" value="<?php echo $Password; ?>" required/><br/>
                        </div>
                        <br/><br/>
                        <div class="form-group">
