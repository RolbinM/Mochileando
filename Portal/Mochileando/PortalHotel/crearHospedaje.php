...
<body id="body">
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">	
            ...
            <a href="crearHospedaje.php" class="selected" style="text-decoration:none">
                <div class="option">
    ...
    <main>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-5 rounded shadow bg-dark">
                        <h2 class="text-center font-weight-bold">Crear un Hospedaje</h2>
                    </div>
                </div>
                <br>
                <div class="row justify-content-center">    
                    <div class="col-lg-7">
                        <form  method="POST" class="mt-1 pt-1" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="number" name="espacios" required class="form-control">
                                </div>
                            </div>
                            <br>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <textarea name="descripcion" rows="10" cols="40" required class="form-control"></textarea>
                                </div>
                            </div>
                            <br><br>
                            <div class="mb-3">
        ...
        <?php
            if(isset($_POST['enviar'])){
                ...
                $consulta = "EXECUTE dbo.sp_CrearHospedaje '$usuario', '$nombre', '$descripcion', 
                            $espacios, $precio";
                ...
                if($ejecutar){
                    ...
                    if($fila->Codigo == 0) {
                        echo"<script>alert('Se agrego correctamente el hospedje')</script>";
                        echo"<script>window.open('crearHospedaje.php', '_self')</script>";
